...
//  Destini
//
//  Created by Rami Saraiji on 26/09/2018.
//  Copyright © 2018 Rami Saryji. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var Restast: UIButton!
    
    var storyIndex = 1

    override func viewDidLoad() {
        super.viewDidLoad()
        Restast.isHidden = true
